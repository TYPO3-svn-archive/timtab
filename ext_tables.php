...
if (@is_file($file)) {
	$EM_CONF = array();
	include_once($file);
	$ttNewsVersion = $EM_CONF[$_EXTKEY]['version'];
}
...
$TCA['tx_timtab_blogroll'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'hidden, url, name, description, rel_identity, rel_friendship, rel_physical, rel_professional, ' .
			'rel_geographical, rel_family, rel_romantic, img_uri, rss_uri, notes, rating, target',
	)
);
...
if (version_compare($ttNewsVersion, '3.0.0', '>=')) {
	...
	t3lib_extMgm::addToAllTCAtypes(
		'tt_news',
		'--div--;Blog Post,tx_timtab_trackbacks;;;;1-1-1,tx_timtab_comments_allowed;;;;2-2-2,tx_timtab_ping_allowed;;;;',
		3,
		'after:related'
	);
} else {
	...
	t3lib_extMgm::addToAllTCAtypes(
		'tt_news',
		'title;;1;;,type,editlock,datetime;;2;;1-1-1,author;;3;;,short,bodytext;;4;' .
			'richtext[paste|bold|italic|underline|formatblock|class|left|center|right|orderedlist|unorderedlist|outdent|indent|link|table|image]:' .
			'rte_transform[flag=rte_enabled|mode=ts];4-4-4,no_auto_pb,--div--;Relations,category,image;;;;1-1-1,imagecaption;;5;;,' .
			'links;;;;2-2-2,related;;;;3-3-3,news_files;;;;4-4-4,--div--;Blog Post,tx_timtab_trackbacks;;;;1-1-1,' .
			'tx_timtab_comments_allowed;;;;2-2-2,tx_timtab_ping_allowed;;;;',
		3
	);
...
t3lib_extMgm::addPlugin(
	array(
		'LLL:EXT:timtab/locallang_db.xml:tt_content.list_type_pi1',
		$_EXTKEY . '_pi1'
	),
	'list_type'
);
...
t3lib_extMgm::addPiFlexFormValue(
	$_EXTKEY . '_pi1', 'FILE:EXT:' . $_EXTKEY . '/pi1/flexform.xml'
);
